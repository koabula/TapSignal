...
### 7.1 状态指示 ✅
- [x] 群组对话顶部显示 v2 mode 指示器
- [x] 显示当前状态（PROPOSING/FULL_V2_ACTIVE）
- [x] 在 PROPOSING 状态显示同意人数（3/5 已同意）
- [x] 添加状态图标和颜色

### 7.2 菜单集成 ✅
- [x] 在群组菜单中添加"Use v2 mode"选项
- [x] 在群组菜单中添加"Disable v2 mode"选项
- [x] 动态显示提议进度
- [x] 实现启用/禁用确认对话框
...
### 7.4 AndroidManifest ✅
- [x] 注册 GroupTokenExchangeReceiver

### 7.5 设置和管理 (待 Phase 7.5 可选实现)
- [ ] 群组信息页面显示 v2 mode 状态详情
- [ ] 显示成员的同意状态列表
- [ ] 添加手动重新同步选项
- [ ] Provider 配置检查和提示
