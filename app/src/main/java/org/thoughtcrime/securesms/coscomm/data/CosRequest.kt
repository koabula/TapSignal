...
data class CosAccessInfo(
     ...
     */
    @JsonIgnore
    fun toCosAccessToken(): org.thoughtcrime.securesms.cos.CosAccessToken {
        return org.thoughtcrime.securesms.cos.CosAccessToken(
 ...
 */
fun CosAccessInfo.toCosAccessToken(): org.thoughtcrime.securesms.cos.CosAccessToken {
    return org.thoughtcrime.securesms.cos.CosAccessToken(
 ...
 */
fun org.thoughtcrime.securesms.cos.CosAccessToken.toCosAccessInfo(
    provider: String,
    region: String,
    bucketName: String,
