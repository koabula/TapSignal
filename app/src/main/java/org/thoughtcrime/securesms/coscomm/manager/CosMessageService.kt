...
sealed class CosListResult {
    data class Success(val files: List<org.thoughtcrime.securesms.cos.CosFileInfo>) : CosListResult()
    ...
    companion object {
        fun success(files: List<org.thoughtcrime.securesms.cos.CosFileInfo>) = Success(files)
        fun failure(error: String) = Failure(error)
    }
}
