...
object PermanentCredentialTest {
    ...
    private fun testCosRequestManagerIntegration(context: Context) {
        ...
        val testCases = listOf(
            org.thoughtcrime.securesms.coscomm.data.CosDuration.ONE_HOUR to false,
            org.thoughtcrime.securesms.coscomm.data.CosDuration.ONE_DAY to false,
            org.thoughtcrime.securesms.coscomm.data.CosDuration.ONE_WEEK to false,
            org.thoughtcrime.securesms.coscomm.data.CosDuration.PERMANENT to true
        )
