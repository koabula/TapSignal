...
object TencentCamUinFixTest {
    ...
    private fun testAttachCustomPolicySignature(): UinTestStep {
        return try {
            val managerClass = Class.forName("org.thoughtcrime.securesms.cos.tencent.TencentSubUserManager")
            val method = managerClass.getDeclaredMethod(
                "attachCustomPolicy", 
                String::class.java,  // userName
                Long::class.java,    // userUin - 新增参数
                org.thoughtcrime.securesms.cos.CosPermission::class.java  // permissions
            )
