...
object CompilationCheck {
    ...
    private fun verifyUtilityClasses() {
        ...
        // 验证AwsSigner可以调用
        val hash = org.thoughtcrime.securesms.cos.aws.AwsSigner.hash("test")
        
        // 验证TencentSigner可以调用
        val authorization = org.thoughtcrime.securesms.cos.tencent.TencentSigner.buildTC3AuthorizationHeader(
            secretId = "test",
            secretKey = "test",
            service = "sts",
            region = "ap-beijing",
