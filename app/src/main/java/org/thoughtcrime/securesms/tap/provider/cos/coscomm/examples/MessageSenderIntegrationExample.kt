...
import org.thoughtcrime.securesms.tap.provider.cos.coscomm.integration.SignalMessageSendIntegrator
import org.thoughtcrime.securesms.tap.provider.cos.coscomm.integration.SignalSenderCallback
import org.thoughtcrime.securesms.tap.provider.cos.coscomm.integration.SignalSendResult
import org.thoughtcrime.securesms.tap.provider.cos.coscomm.integration.IntegratedSendResult
import org.thoughtcrime.securesms.tap.provider.cos.coscomm.manager.MessageSendMethod
import org.thoughtcrime.securesms.tap.provider.cos.coscomm.data.CosChannelStatistics
...
data class MessageStatusInfo(
    ...
    val status: org.thoughtcrime.securesms.tap.provider.cos.coscomm.manager.SendStatus,
    val startTime: Long,
    val endTime: Long?,
    val retryCount: Int,
