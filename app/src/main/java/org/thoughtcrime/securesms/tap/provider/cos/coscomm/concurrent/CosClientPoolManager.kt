package org.thoughtcrime.securesms.tap.provider.cos.coscomm.concurrent
...
class CosClientPoolManager private constructor(private val context: Context) {
    ...
    private inner class ClientPool(val accessInfo: CosAccessInfo) {
        ...
        private val activeClients = ConcurrentHashMap<org.thoughtcrime.securesms.tap.provider.cos.cos.CosClient, PooledClient>()
         ...
         * 获取客户端
         */
        fun borrowClient(): org.thoughtcrime.securesms.tap.provider.cos.cos.CosClient? {
         ...
         * 归还客户端
         */
        fun returnClient(client: org.thoughtcrime.securesms.tap.provider.cos.cos.CosClient) {
        ...
        private fun createNewClient(): PooledClient? {
            return try {
                ...
                val future = CompletableFuture.supplyAsync {
                    ...
                    val config = org.thoughtcrime.securesms.tap.provider.cos.cos.CosConfig(
                        provider = org.thoughtcrime.securesms.tap.provider.cos.cos.CosConfig.Provider.valueOf(accessInfo.provider.toString()),
    ...
    private data class PooledClient(
        val client: org.thoughtcrime.securesms.tap.provider.cos.cos.CosClient,
        var lastUsed: Long
    )
     ...
     * 获取或创建COS客户端（兼容方法）
     */
    fun getOrCreateClient(accessInfo: CosAccessInfo): org.thoughtcrime.securesms.tap.provider.cos.cos.CosClient? {
     ...
     */
    fun getCosClient(accessInfo: CosAccessInfo): org.thoughtcrime.securesms.tap.provider.cos.cos.CosClient? {
     ...
     * 归还COS客户端
     */
    fun returnClient(accessInfo: CosAccessInfo, client: org.thoughtcrime.securesms.tap.provider.cos.cos.CosClient) {
        val poolKey = getPoolKey(accessInfo)
     ...
     * 安全关闭客户端
     */
    private fun closeClient(client: org.thoughtcrime.securesms.tap.provider.cos.cos.CosClient) {
        try {
